...
export class AuthRoutes {
  ...
  constructor() {
     ...
     *     responses:
     *       200:
     *         description: Token is valid — returns the invited email
     *         content:
     *           application/json:
     *             schema:
     *               type: object
     ...
     *   post:
     *     tags: [Auth]
     *     summary: Complete admin registration using an invitation token
     *     requestBody:
     *       required: true
     *       content:
     *         application/json:
     ...
     */
    this.router.post('/admin-registration', this.controller.adminRegister);
     ...
     *     responses:
     *       200:
     *         description: Login successful — JWT and admin user returned
     *         content:
     *           application/json:
     *             schema:
     *               $ref: '#/components/schemas/AuthResponse'
     ...
     *         description: Invalid credentials
     *       403:
     *         description: Not an admin, or account pending approval
     */
