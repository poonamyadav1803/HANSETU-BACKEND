...
const data: InsertTrainingProgram[] = [
  ...
  // ── From GGI seed data ───────────────────────────────────────────────────
  { name: "Technical Training on Material Selection", category: "Raw Materials", industrySlug: "automobile", provider: "GGI Platform", price: "₹25,000 per batch", duration: "2 days", mode: "Hybrid", city: "Pune", rating: "4.6", capacity: "10-15 per batch", certification: "Material Selection Specialist", skills: JSON.stringify(["Material Properties", "Testing Methods", "Selection Criteria", "Cost Optimization"]), description: "Hands-on training program on selecting appropriate materials for automotive components.", isActive: true },
];
