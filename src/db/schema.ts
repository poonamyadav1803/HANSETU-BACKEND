...
export const rfqAssignments = pgTable("rfq_assignments", {
  ...
  assignmentMode: varchar("assignment_mode", { length: 30 }).default("REQUEST_QUOTE").notNull(),
  // REQUEST_QUOTE | DIRECT_PRICE
...
export const purchaseOrders = pgTable("purchase_orders", {
  ...
  supplierPaymentAmount: numeric("supplier_payment_amount", { precision: 14, scale: 2 }),
  supplierPaymentDate: varchar("supplier_payment_date", { length: 50 }),
  supplierReceiptUrl: varchar("supplier_receipt_url", { length: 500 }),
  supplierAckReceiptUrl: varchar("supplier_ack_receipt_url", { length: 500 }),
  transporterPaymentId: varchar("transporter_payment_id", { length: 100 }),
  transporterPaidAt: timestamp("transporter_paid_at"),
  transporterPaymentAmount: numeric("transporter_payment_amount", { precision: 14, scale: 2 }),
  transporterPaymentDate: varchar("transporter_payment_date", { length: 50 }),
  transporterReceiptUrl: varchar("transporter_receipt_url", { length: 500 }),
...
export const salesInvoices = pgTable("sales_invoices", {
  ...
  productBaseAmount: numeric("product_base_amount", { precision: 14, scale: 2 }).notNull(),
  deliveryCharge: numeric("delivery_charge", { precision: 14, scale: 2 }).default("0").notNull(),
  baseAmount: numeric("base_amount", { precision: 14, scale: 2 }).notNull(),
